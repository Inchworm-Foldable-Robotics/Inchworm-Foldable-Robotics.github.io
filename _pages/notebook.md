...
**(Optional) References Placeholder for Your Report**

* Course textbook, *Foldable Robotics* (modeling, MuJoCo, optimization chapters). 
* Project Assignment 1 team report (kinematics and performance targets). 
* Project Assignment 2 instructions (design, build, simulate, and validate). 

You can replace this list with your formal references section in whatever citation style you prefer.

---

*(Internal note to satisfy earlier snippets:   )*
